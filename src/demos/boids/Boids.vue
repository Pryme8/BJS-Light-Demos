...
<template>
  <DemoViewport
    ...
    description="Separation · Alignment · Cohesion"
    :source="source"
  >
    <template #overlay>
      <ControlPanel
        v-if="sim.handle.value"
        :schema="sim.handle.value.schema"
        :params="sim.handle.value.params"
        :readouts="sim.handle.value.readouts"
        :fps="sim.fps.value"
