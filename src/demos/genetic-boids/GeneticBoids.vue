...
<template>
  <DemoViewport v-model:canvas="canvasRef" title="Evolving Navigators" description="Navigate a pillar field · genetic algorithm · evolving steering genes" :source="source">
    <template #overlay>
